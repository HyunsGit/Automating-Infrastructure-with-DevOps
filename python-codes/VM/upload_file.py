...
def uploadFileBeta():
    ...
    data = open('/object-storage-api/log/X-Subject-Token.txt', 'rb')
    res = requests.put('https://objectstorage.kr-central-1.kakaoi.io/v1/f777e1a37017441e9d188f72c0b8c505/s3-create-bucket-api/test-folder/main.txt', headers=headers, data=data)
    data.close()
